...
export function calculateSankey(data, width, height) {
...
export function drawSankey({ data, width, height, svgRef }) {
  const colors = interpolateWarm;

  const { links, nodes } = calculateSankey(data, width, height);
